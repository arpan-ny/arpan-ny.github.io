...
const Footer: React.FC = () => {
  return (
    <footer className="w-full p-4 md:p-8 text-center bg-transparent border-t border-gray-200 mt-8 md:mt-16">
      <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-6 text-gray-700 text-sm" style={{ color: "var(--text-color)" }}>
        <a
